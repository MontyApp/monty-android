...
data class ChangeAddressReducer(private val address: Address) : CreateAdvertReducer() {
    override fun reduce(oldState: CreateAdvertState) = oldState.copy(address = address)
}
